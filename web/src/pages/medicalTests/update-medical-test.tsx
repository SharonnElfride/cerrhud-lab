import MedicalTestForm from "@/components/medical-tests/medical-test-form";
...
interface UpdateMedicalTestProps {
...
export { UpdateMedicalTest, type UpdateMedicalTestProps };
